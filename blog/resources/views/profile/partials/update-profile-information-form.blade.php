<section>
    ...
    <br>
    <label for="biography" class="mt-2">Biography:</label>
    <br>
    <textarea id="biography" name="biography" class="mt-1 block w-full" rows="4">{{ old('biography', auth()->user()->biography) }}</textarea>
